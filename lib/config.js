...
const DEFAULT_CONFIG = {
  ...
  deptCompanyMap: {},
  deptAutoRouteMap: {},
  // Shift roster (absen pola engine)
  scheduleAutoGenerateEnabled: true,
  scheduleAutoGenerateDay: 15, // tiap tgl 15 generate bulan berikutnya
  scheduleAutoGenerateHour: 1, // jam server (0–23)
  lastScheduleAutoGenerateKey: "", // e.g. "2026-08"
};
